...
int compare_exact(const void* a, const void* b){			// compare-function for quick sort of the Dist-structure array
...
int main(){
	...
	const double DELTA = 1.0e-10;						// max deviation between the same points on the two maps
